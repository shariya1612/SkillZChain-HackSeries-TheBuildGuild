...
import { ArenaMobileNav } from "@/components/arenas/mobile-nav" // Import the mobile nav
...
export default function SoloGamesPage() {
  ...
  const filteredGames = soloGames.filter(
    (game) =>
          ...
          <div className="container mx-auto px-4 py-6 md:py-8">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6 md:mb-8">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-2xl md:text-3xl font-bold text-white flex items-center">
                  <Gamepad2 className="mr-2 h-5 w-5 md:h-6 md:w-6 text-blue-400" /> Solo Games
                </h1>
              </div>
            ...
            {filteredGames.length === 0 ? (
              <div className="bg-slate-800/30 backdrop-blur-md rounded-xl p-6 md:p-8 border border-slate-700/50 shadow-lg shadow-purple-900/10 text-center">
                <Gamepad2 className="h-12 w-12 md:h-16 md:w-16 text-slate-400 mx-auto mb-4" />
