        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-slate-800/30 border border-slate-700 rounded-lg overflow-hidden">
            <div className="relative h-64 md:h-80">
              <Image
                src="/games/flappy-bird.png"
                alt="Crypto Flappy Bird"
                fill
                className="object-cover"
                onError={(e) => {
                  // Fallback if image fails to load
                  const target = e.target as HTMLImageElement
                  target.src = "/placeholder.svg?key=2aslq"
                }}
              />
            </div>

            <div className="p-6">
              <h1 className="text-2xl md:text-3xl font-bold mb-4">Crypto Flappy Bird</h1>
              <p className="text-slate-300 mb-6">
                Navigate your crypto bird through obstacles to earn tokens in this blockchain twist on the classic game.
                Collect Algorand tokens as you fly through the pipes!
              </p>

              <div className="flex flex-wrap gap-4 mb-6">
                <div className="bg-slate-700/50 px-3 py-1.5 rounded-full text-sm">
                  <span className="text-slate-300">Category:</span>{" "}
                  <span className="text-white font-medium">Arcade</span>
                </div>
                <div className="bg-slate-700/50 px-3 py-1.5 rounded-full text-sm">
                ...
                <div className="bg-slate-700/50 px-3 py-1.5 rounded-full text-sm">
                  ...
                  <span className="text-white font-medium">1-50 SKILLZ</span>
                </div>
              </div>

              {/* Simple link button to the game page */}
              <Link href="/arenas/solo/13/play">
